...
export default function SignInPage(props, context) {
    ...
    const handleLogin = () => {
        axios.post(Configuration.API_ENDPOINT + '/auth/admin_sign_in', {
            email: email,
            password: password
        }).then((resp) => {
            sessionStorage.setItem("adminToken", resp.data.accessToken);
            history.push("/admin/");
        });
    };
        ...
        <Grid container component="main" className={classes.root}>
            ...
            <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                <div className={classes.paper}>
                    ...
                    <Grid container>
                        <Grid item xs>
                            <Link component={RouterLink} to="/adminResetPwd" variant="body2">
                                找回密码
                            </Link>
                        </Grid>
                        <Grid item>
