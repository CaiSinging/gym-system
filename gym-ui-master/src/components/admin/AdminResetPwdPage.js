...
class AdminResetPwdPage extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            tel: '',
    ...
    render() {
        ...
        const handleSubmit = function () {
            if (self.state.newPassword !== self.state.repeatPassword) {
                ...
                axiosInstance.post("/admin/resetPassword", {
                    tel: self.state.tel,
...
AdminResetPwdPage.propTypes = {
    classes: PropTypes.object.isRequired,
};
export default withStyles(styles)(AdminResetPwdPage);